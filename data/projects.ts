...
export const projects: Project[] = [
  {
    ...
    description:
      "A records management system that incorporated an access-level based multi-user mechanism where users (initially academic staff) share and store, manage, and retrieve text, files, and other kinds of data",
    fullDescription:
