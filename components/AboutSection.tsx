...
export default function AboutSection() {
  ...
  return (
    <section id="about" ref={ref} className="bg-background px-8 py-64 lg:px-50">
        ...
        >
          ...
          >
            <Image
              ...
              className="neon-glow h-auto w-full rounded-2xl object-contain lg:h-150"
            />
          </motion.div>
          ...
          >
            ...
            <div>
              <h4
                className={cn(
                  "text-foreground mb-6 text-3xl font-semibold transition-all delay-[3s] duration-1000",
                  picHovered && "text-gradient-1",
                )}
              >
                Skills
              </h4>
              <div className="flex flex-wrap gap-3">
                {skills.map((skill, index) => (
                  <motion.span
                    key={skill}
                    className="bg-card text-card-foreground border-primary/30 hover:border-primary cursor-default rounded-lg border px-6 py-3 text-base transition-colors"
